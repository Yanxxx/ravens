...
from ravens.dataset_modified import Dataset
...
#  print(tasks.names['excavation'])
  ...
  while dataset.n_episodes < FLAGS.n:
    ...
    for _ in range(task.max_steps):
      ...
      record_count = np.random.randint(len(actions) // 5, len(actions))
#      print(actions)
#      episode.append((obs, act, reward, info))
      for count, a in enumerate(actions):
#          atmp = {}
...
#              print(info)
              print('saved info.')
              episode.append((obs, a, pose, info))
